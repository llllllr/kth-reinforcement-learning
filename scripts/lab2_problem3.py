...
def reload_nn_and_test():
    nn_dir = Path(__file__).parent.parent / "results_version1_backup_to_0327_3" 
...
# "results_version1_with_limit_2"

    # results_dir = Path(__file__).parent.parent / "results_version1_backup_to_0327_3" 
